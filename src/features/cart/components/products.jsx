        ...
        <div className='border-2 border-border border-dashed rounded-xl overflow-hidden'>
            <table className='w-full'>
                ...
                <tbody className='border-t-2 border-border border-dashed'>
                    <tr className='capitalize text-text-muted text-base md:text-lg transition-all duration-300'>
                        ...
                        <td className='text-center pl-2.5 pr-2.5 sm:pl-5 sm:pr-5 pt-5 pb-5 transition-all duration-300 text-text-main font-medium'>$999</td>
                        <td className='text-center pl-2.5 pr-2.5 sm:pl-5 sm:pr-5 pt-5 pb-5 transition-all duration-300'>2</td>
                        <td className='text-center pl-2.5 pr-2.5 sm:pl-5 sm:pr-5 pt-5 pb-5 transition-all duration-300 text-text-main font-medium'>$1998</td>
                    </tr>
                </tbody>
            </table>
        </div>
