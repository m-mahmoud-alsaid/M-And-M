...
function CategoryList() {
    ...
    return (
        <ul className='animate-come-from-left rounded-lg shadow-lg shadow-shadow-md overflow-x-hidden overflow-y-auto bg-border text-text-main transition-all duration-300'>
